  ...
  <div id="content"> 
    ...
    <section class="padding-top-100 padding-bottom-100">
      <div class="container"> 
        ...
        <div class="shop-detail">
          <div class="row"> 
            ...
            <div class="col-md-7"> 
              ...
              <div class="images-slider">
                <ul class="slides list-unstyled">
                  <li data-thumb="images/large-img-1.jpg"> <img class="img-responsive" src="{{ asset('img/product-1.png') }}"  alt=""> </li>
                  <li data-thumb="images/large-img-2.jpg"> <img class="img-responsive" src="{{ asset('img/product-1.png') }}"  alt=""> </li>
                  <li data-thumb="images/large-img-3.jpg"> <img class="img-responsive" src="{{ asset('img/product-1.png') }}"  alt=""> </li>
                </ul>
              </div>
              <div class="row justify-content-center"> 
                <!-- Popular Images Picker -->
                <div class="col-md-2"> 
                    <img class="img-responsive" src="{{ asset('img/product-1.png') }}"  alt="">
                </div>
                <div class="col-md-2"> 
                    <img class="img-responsive" src="{{ asset('img/product-1.png') }}"  alt="">
                </div>
            ...
            <div class="col-md-5">
              ...
              <ul class="item-owner list-unstyled">
              ...
              <!-- Short By -->
              <div class="some-info">
                <ul class="row margin-top-30 list-unstyled">
                  <li class="col-xs-4">
                    <div class="quinty"> 
                      <!-- QTY -->
                  ...
                  <!-- COLORS -->
                  <li class="col-xs-8">
                    <ul class="colors-shop list-unstyled">
                  ...
                  <!-- ADD TO CART -->
                  <li class="col-xs-6"> <a href="#." class="btn font1">ADD TO CART</a> </li>
        ...
        <div class="item-decribe"> 
          <!-- Nav tabs -->
          <ul class="nav nav-tabs animate fadeInUp list-unstyled" data-wow-delay="0.4s" role="tablist">
            ...
            <div role="tabpanel" class="tab-pane fade" id="review">
              ...
              <div class="media">
                <div class="media-left"> 
                  <!--  Image -->
                  <div class="avatar"> <a href="#"> <img class="media-object" src="{{ asset('img/product-1.png') }}" alt=""> </a> </div>
                </div>
                <!--  Details -->
    ...
    <section class="light-gray-bg padding-top-150 padding-bottom-150">
      <div class="container"> 
        ...
        <!-- Popular Item Slide -->
        <div class="row papular-block block-slide single-img-demos"> 
           <div class="col-md-3">
            <!-- Item -->
            <div class="item"> 
                <!-- Item img -->
